...
let content;
  ...
  return (
    <div className="w-full flex flex-col items-center pb-28 lg:pb-0">
        ...
        <div className="w-full lg:grid lg:grid-cols-8 px-2 md:px-20 mt-2 md:mt-4 mb:pb-0 md:gap-5 mb:mb-0">
          <SideBar
          ...
          {/* main section  */}
          <div className="main w-full flex flex-col col-span-4 border-r-[1px] border-l-[1px] border-black/5 dark:border-neutral-300/10">
            <h1 className="p-5 text-xl font-bold bg-base-100/50 dark:bg-black/50 backdrop-blur-sm sticky top-0 z-[100]">Notifications</h1>
          ...
          {/* side bar */}
          <div className="side-nav hidden sticky right-0 top-5 lg:flex flex-col gap-5 h-fit col-span-2 py-3 border-[1px] border-black/5 dark:border-neutral-300/10 rounded-md">

              <h2 className="font-bold text-xl px-3">Suggested for you</h2>
